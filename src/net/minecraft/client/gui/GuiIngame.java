...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
		...
		/* Credit */
        this.drawCenteredString(mc.fontRendererObj, "§aBu client FatihUlu tarafýndan yapýlmýþtýr.", (mc.fontRendererObj.getStringWidth("Bu client FatihUlu tarafýndan yapýlmýþtýr.")/2)+4, j-10, -1);
