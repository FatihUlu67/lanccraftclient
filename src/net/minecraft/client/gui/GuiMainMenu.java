...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/lanccraft/wallpaper.jpg")); // setting wallpaper - FatihUlu
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/lanccraft/logo.png")); // setting logo - FatihUlu
        GlStateManager.color(1F, 1F, 1F);
		...
		float u = 0;
		float v = 0;
		this.drawModalRectWithCustomSizedTexture(this.width / 2 - 80, this.height / 4 - 10, u, v, w, h, fw, fh);
        ...
        this.drawString(this.fontRendererObj, "§9Discord: §cFatih Ulu#1923", 2, this.height - 20, -1); // credit - FatihUlu
