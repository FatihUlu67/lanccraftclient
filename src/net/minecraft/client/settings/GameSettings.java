...
public class GameSettings
{
    ...
    public KeyBinding TestGuiKey = new KeyBinding("TestGui", Keyboard.KEY_M, "FatihClient"); // FatihUlu - M key for opening gui
    ...
    private void addClientKeybinds() {
    	this.keyBindings = (KeyBinding[])((KeyBinding[])ArrayUtils.add(this.keyBindings, this.TestGuiKey));
	}
