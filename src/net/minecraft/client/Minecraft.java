...
import me.FatihUlu.client.Client;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
    	Client.getInstance().init(); // FatihUlu - init client
        ...
        Client.getInstance().start(); // FatihUlu - StartClient
    }
    ...
    public void runTick() throws IOException
    {
        ...
        new ClientTickEvent().call(); // FatihUlu
